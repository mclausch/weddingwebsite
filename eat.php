	...
	<div class="row">
		<div class="col-md-12">
			...
			<ul class="inline-bullets">
				<li><a class="body-link" href="https://sf.eater.com/" target="_blank">Eater SF</a> &mdash; Reviews and lists of all the best restaurants in the Bay Area, including articles like these:</li>
				<ul>
					...
					<li><a class="body-link" href="https://sf.eater.com/maps/best-san-francisco-bakeries" target="_blank">San Francisco's Essential Bakeries</a></li>
					<li><a class="body-link" href="https://sf.eater.com/maps/best-brunch-san-francisco" target="_blank">The Essential Brunches of San Francisco</a></li>
					<li><a class="body-link" href="https://sf.eater.com/maps/best-essential-burgers-san-francisco" target="_blank">27 Essential San Francisco Burgers</a></li>
					<li><a class="body-link" href="https://sf.eater.com/maps/best-ice-cream-san-francisco" target="_blank">17 Essential Ice Cream Shops in San Francisco</a></li>
				</ul>
			...
			<p>Without further ado, here is our big list (in no particular order)! You can also view all of these places and more on our annotated <a class="body-link" href="https://drive.google.com/open?id=1Wsad_ctX5PhXNhI0BLrNKqU8f5Q&amp;usp=sharing" target="_blank">Google Map</a>.</p>

			<hr/>

			<h3 class="heading-<?php echo $gPageColor; ?>"><strong>Food Near the Hotels</strong></h3>
			<p>The following restaurants are located within short walking distance of one of our <a class="body-link" href="http://sarah-and-matthew.com/accommodations.php">Wedding Hotels</a>.</p>
			<ul class="inline-bullets">
				<li><a class="body-link" href="http://thegrovesf.com" target="_blank">The Grove</a> &mdash; cheap, easy, tasty, American comfort food, in a casual setting that stays open late</li>
				...
				<li><a class="body-link" href="http://spqrsf.com" target="_blank">SPQR</a> &mdash; gourmet Italian food and wine</li>
			...
			<h3 class="heading-<?php echo $gPageColor; ?>"><strong>Markets and Food Trucks</strong></h3>
			<p>San Francisco has a ton of food markets to explore and the food truck culture is also very strong. Be sure to check some out for cheap, fresh, and innovative food.</p>
			<ul>
				<li><a class="body-link" href="https://www.ferrybuildingmarketplace.com/" target="_blank">Ferry Building</a> &mdash; San Francisco's main ferry terminal is also a massive food hall, and on Saturday mornings is the site of an enormous farmers' market, one of our favourites in the city</li>
				<li><a class="body-link" href="https://agriculturalinstitute.org/directory/listing-details/clement-st" target="_blank">Clement St Farmers' Market</a> &mdash; Our local farmers' market that runs every Sunday morning and located just three blocks from our apartment</li>
				<li><a class="body-link" href="http://sfgov.org/realestate/alemany-farmers-market" target="_blank">Alemany Farmers' Market</a> &mdash; The first farmers' market in California, open Saturday</li>
				<li><a class="body-link" href="https://agriculturalinstitute.org/directory/listing-details/sunday-san-rafael-market" target="_blank">San Rafael Market</a> &mdash; located just north of the city in San Rafael, this epic market is the third largest in California and a hidden gem, open Sunday mornings</li>
				<li><a class="body-link" href="https://offthegrid.com/" target="_blank">Off the Grid</a> &mdash; A series of food truck festivals located throughout the city, our favourites are the Presidio Picnic on Sundays on the Main Post lawn and the one at Fort Mason on Fridays...but check the website for full details of the 2018 season starting in April</li>
				<li><a class="body-link" href="http://sparksocialsf.com/" target="_blank">Spark Social SF</a> &mdash; A permanent collection of food trucks located in a newly developed neighbourhood</li>
			</ul>

			<hr/>

			<h3 class="heading-<?php echo $gPageColor; ?>"><strong>American/Californian</strong></h3>
			<ul>
				...
				<li><a class="body-link" href="http://thegrovesf.com" target="_blank">The Grove</a> &mdash; cheap, easy, tasty, American comfort food, in a casual setting that stays open late</li>
				<li><a class="body-link" href="https://www.beachchalet.com/" target="_blank">Beach Chalet</a> &mdash; good food with fantastic view of the ocean</li>
				<li><a class="body-link" href="https://themelt.com/" target="_blank">The Melt</a> &mdash; fancy grilled cheese</li>
			...
			<h3 class="heading-<?php echo $gPageColor; ?>"><strong>Chinese</strong></h3>
			<ul>
				<li><a class="body-link" href="https://www.missionchinesefood.com/sfo/" target="_blank">Mission Chinese Food</a> &mdash; delicious Chinese food located in the Mission</li>
				<li><a class="body-link" href="http://yanksing.com/" target="_blank">Yank Sing</a> &mdash; great Dim Sum downtown</li>
				<li><a class="body-link" href="http://www.hongkonglounge2.com/" target="_blank">Hong Kong Lounge 2</a> &mdash; great Dim Sum in the Richmond District (i.e. the real chinatown)</li>
				<li><a class="body-link" href="http://spicessf.com/" target="_blank">Spices</a> &mdash; tasty, spicy noms</li>
			</ul>

			<hr/>

			<h3 class="heading-<?php echo $gPageColor; ?>"><strong>German</strong></h3>
			<ul>
				<li><a class="body-link" href="http://biergartensf.com/" target="_blank">Biergarten</a> &mdash; Bavarian style outdoor beer garden with tasty pretzels and sausages and beer</li>
				<li><a class="body-link" href="http://www.suppenkuche.com" target="_blank">Suppenkuche</a> &mdash; best German food in the city</li>
			</ul>

			<hr/>

			<h3 class="heading-<?php echo $gPageColor; ?>"><strong>Indian</strong></h3>
			<ul>
				<li><a class="body-link" href="http://dosasf.com" target="_blank">Dosa</a> &mdash; delicious South Indian food located in the Fillmore District</li>
			...
			<h3 class="heading-<?php echo $gPageColor; ?>"><strong>Italian & Pizza</strong></h3>
			<ul>
				<li><a class="body-link" href="http://spqrsf.com" target="_blank">SPQR</a> &mdash; gourmet Italian food and wine</li>
				<li><a class="body-link" href="https://sfsociale.com/" target="_blank">Sociale</a> &mdash; fine Italian food near our apartment</li>
				<li><a class="body-link" href="http://www.delpopolosf.com/" target="_blank">Del Popolo</a> &mdash; amazing wood-fired pizza</li>
			...
			<h3 class="heading-<?php echo $gPageColor; ?>"><strong>Japanese</strong></h3>
			<ul>
				<li><a class="body-link" href="http://hinodeyaramen.com" target="_blank">Hinodeya Ramen</a> &mdash; tasty ramen near the Buchanan in Japantown</li>
