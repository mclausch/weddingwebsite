...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			...
			<p>Many of the bridges in the Bay Area have tolls. The Golden Gate Bridge charges a toll in the southbound direction (coming into the city) and the Bay Bridge (from Oakland) charges a toll in the westbound direction (also coming into the city). The Bay Bridge has cash toll lanes, but the Golden Gate Bridge has automated tolls only. Check with your rental car company about their policy on tolls to avoid big service charges (most have a plans for paying tolls in the Bay Area). For more information about bridge tolls in the Bay Area, check out the <a class="body-link" href="https://www.bayareafastrak.org/en/guide/visitorsRentals.shtml" target="_blank">FasTrak</a> website.</p>
			<p>Another option for renting a car is <a class="body-link" href="http://www.zipcar.com" target="_blank">Zipcar</a>, a by-the-hour or by-the-day, on-demand car rental service. Zipcar is available in Toronto and other major cities, and if you're already a member then you are free to use it in San Francisco too. If you're not a member and are interested in using it here, ensure that you sign up in your local market before arriving in San Francisco. All Zipcars in the Bay Area have a FasTrak transceiver for automatically paying bridge tolls (cost will be billed to your Zipcar account).</p>
			<hr/>
