	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="panel-group panel-group-<?php echo $gPageColor; ?>" id="toSFaccordion">
				...
				<div class="panel-body">
					...
					<div class="panel-group panel-group-<?php echo $gPageColor; ?>" id="toSFaccordionAir">
						...
						<div class="panel-body">
							<p>SFO/OAK are serviced by all major car rental companies. As with all cities however, driving (and parking) in San Francisco is often more hassle than it is worth. Note also that the prices for our <a href="accommodations.php">hotel room blocks</a> do not include parking, which is approximately $40/night.</p>
						</div>
						</div>
						</div>
			...
			<div class="panel-group panel-group-<?php echo $gPageColor; ?>" id="toWeddingAccordion">
				...
				<div class="panel-body">
					<p>Your hotel can help you arrange a taxi to the venue. Fares should be less than $20 from the hotels. At the end of the evening please ask us if you need help arranging a ride back to your hotel.</p>
				</div>
				</div>
				</div>
				...
				<div class="panel-body">
					<p>There are so many fantastic ways to walk or bike through the Presidio to the Log Cabin. Spend the day exploring to work up an appetite before the big event! Check out the <a href="do.php">activities</a> page for some ideas.</p>
				</div>
				</div>
				</div>
