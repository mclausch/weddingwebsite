			...
			<div class="panel-group panel-group-<?php echo $gPageColor; ?>" id="toSFaccordion">
				...
				<div class="panel-body">
					...
					<div class="panel-group panel-group-<?php echo $gPageColor; ?>" id="toSFaccordionAir" style="padding-left:20px;">
						...
						<div class="panel-body">
							<p>Modern ridesharing was born in the San Francisco Bay Area and is used heavily all over the region. If you will have a smartphone with a data plan when you arrive at the airport this can be a cheaper (and often easier) option than a regular taxi.</p>
